...
/// parking forever.
///
/// Deliberately a separate object rather than inline state on the owner: `deinit` cannot
/// touch actor-isolated stored properties, but it can rely on a `Sendable` sub-object
/// cleaning up in its own `deinit`.
